...
if [ -f $dockerfile ]; then
    ...
    check $dockerfile 'com.lightbend.rp.endpoints.0.name="akka-remote"'
    check $dockerfile 'com.lightbend.rp.endpoints.0.protocol="tcp"'
    check $dockerfile 'com.lightbend.rp.endpoints.1.name="akka-mgmt-http"'
    check $dockerfile 'com.lightbend.rp.endpoints.1.protocol="tcp"'
    check $dockerfile 'com.lightbend.rp.endpoints.2.protocol="http"'
    check $dockerfile 'com.lightbend.rp.endpoints.2.ingress.0.type="http"'
    check $dockerfile 'com.lightbend.rp.endpoints.2.ingress.0.paths.0="/api/hello/"'
    check $dockerfile 'com.lightbend.rp.endpoints.2.ingress.0.ingress-ports.0="80"'
    check $dockerfile 'com.lightbend.rp.endpoints.2.ingress.0.ingress-ports.1="443"'
else
